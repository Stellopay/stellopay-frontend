...
export default function AgreementsPage() {
  ...
  useEffect(() => {
    ...
    if (connectedWallet && agreementDefault && !hasLoadedOnce) {
      void loadAgreements();
    }
  ...
  }, [connectedWallet, agreementDefault, hasLoadedOnce]);

  const loadAgreements = async () => {
    if (!connectedWallet || !agreementDefault) return;
              ...
              <CardHeader>
                <div>
                  ...
                  <CardDescription className="text-[#A0A0A0]">
                    View all agreements where you are the employer, contributor,
                    or employee
                  </CardDescription>
                </div>
              </CardHeader>
                  ...
                  <div className="space-y-3">
                    {myAgreements.map((agreement) => (
                      <div
                        ...
                        onClick={() =>
                          handleAgreementClick(agreement.agreement_id)
                        }
                      >
