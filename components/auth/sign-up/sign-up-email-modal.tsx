      ...
      <DialogContent className="bg-[#2A1B2E] border-[#2D2D2D] text-white max-w-md">
        ...
        <div className="text-center space-y-4">
          ...
          <div className="space-y-3 pt-4">
            <Button onClick={onContinue} className="w-full bg-white text-black hover:bg-gray-100 font-medium">
              Continue
            </Button>
            <button onClick={onGoBack} className="w-full text-gray-400 hover:text-white text-sm transition-colors">
              Go Back
            </button>
          </div>
        </div>
