...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#040404]">
      <div className="max-w-[1040px] mx-auto h-10 flex items-center justify-center gap-[10px] px-4">
        <Link href="/" className="w-[66px] h-10 flex items-center justify-center p-2">
          <span
        ...
        <Link href="/features" className="w-[66px] h-10 flex items-center justify-center p-2">
          <span
            className="text-[#92918e]  text-[18px] font-normal leading-none tracking-[-0.01em] underline decoration-solid"
            style={{ fontFamily: "General Sans, sans-serif" }}
          >
