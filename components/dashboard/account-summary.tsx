...
export default function AccountSummary() {
  return (
    <div className="max-w-[68.75rem] p-4 rounded-xl h-[12.75rem] gap-4 border-[1px]  border-[#2D2D2D] bg-[#0D0D0D80]">
        <div className="max-w-[66.75rem] h-8 gap-3 mb-4  flex items-center">
            ...
            <div className="max-w-[66.75rem] h-[7.5rem] gap-4 flex justify-between">
                <div className="w-[21.59rem] h-[7.5rem] py-4 px-6 border border-[#2E2E2E] rounded-xl">
                    ...
                    <div className="w-[16.4375rem] h-[17px] gap-1 inline-flex">
