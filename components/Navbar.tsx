    ...
    <nav className="w-full h-[80px] border-b border-[#1A1A1A] bg-[#1a0c1d] px-4 md:px-8">
      <div className="max-w-screen-xl mx-auto h-full flex items-center justify-between gap-4 flex-wrap">
        ...
        <input
          ...
          className="bg-transparent border border-[#1A1A1A] text-white px-4 py-2 rounded-md w-full sm:w-1/2 md:w-1/3 placeholder:text-[#aaa] outline-none"
        />

        {/* Icons and Avatar */}
        <div className="flex items-center gap-4 mt-2 sm:mt-0">
          <div className="p-2 rounded-md bg-[background:rgb(119, 119, 119);
