      ...
      {menuOpen && (
        <div className="md:hidden fixed top-[56px] left-0 w-full bg-[#0a0a0a]/95 shadow-lg z-[100] animate-fade-in">
          <div className="flex flex-col items-center gap-4 py-6">
            ...
            <Link
              href="/sign-in"
              className="px-6 py-2 rounded-full border border-[#598EFF] text-[#EEF4FF] bg-transparent font-medium transition-colors duration-200 hover:bg-[#598EFF] hover:text-white"
              style={{ fontFamily: 'General Sans, sans-serif' }}
              onClick={() => setMenuOpen(false)}
            >
              Log in
