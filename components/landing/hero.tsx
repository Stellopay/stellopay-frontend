  ...
  return (
    ...
    >
      ...
      {!reducedMotion && (
        <>
          <div
            className="absolute z-3 bg-gradient-to-br from-[#10B981] to-[#00000000] w-64.5 h-64.5 lg:w-99 lg:h-99 rounded-full opacity-20 lg:opacity-10 blur-3xl top-[80%] lg:top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
            aria-hidden="true"
          ></div>
          <div
            className="absolute z-3 bg-gradient-to-br from-[#3B82F6] to-[#00000000] w-73.5 h-73.5 lg:w-99 lg:h-99 rounded-full opacity-20 lg:opacity-10 blur-3xl top-[10%] lg:top-[45%] left-[55%] lg:left-[45%] -translate-x-[45%] -translate-y-[45%]"
            aria-hidden="true"
          ></div>
          <div
            className="absolute z-3 bg-gradient-to-br from-[#8B5CF6] to-[#00000000]  w-68 h-68 lg:w-121 lg:h-121 rounded-full opacity-20 lg:opacity-10 blur-3xl lg:top-[53%] left-[40%] lg:left-[53%] -translate-x-[53%] -translate-y-[53%] top-[25%]"
            aria-hidden="true"
          ></div>
        </>
      )}
      ...
      <div className="h-full w-full flex flex-col lg:flex-row items-center justify-center font-[var(--font-sans)] lg:p-5 gap-12 lg:gap-6 my-30">
        ...
        <div className="flex flex-col w-[90%] md:w-[70%] lg:max-w-176 lg:max-h-168.5 h-auto relative gap-5">
          ...
          <a
            href="#"
            className="flex items-center justify-around rounded-full border-[0.74px] relative group border-[#e4e4e7] dark:border-[#27272A] w-78 h-7.5 px-1.5 bg-[#FFFFFF] dark:bg-[#18181B]"
          >
        ...
        >
          ...
          <div
            className={`border-[1.47px] w-22.5 lg:w-23.5 h-22.25 lg:h-23.25 border-[#e4e4e7] dark:border-[#27272A] absolute z-2 bg-[#FFFFFF] dark:bg-[#18181B] rounded-[16px] -top-4 -right-4.5 flex flex-col justify-between items-center p-4 shadow-2xl lg:border-2 transform ${
              reducedMotion ? "" : "rotate-8 dark:rotate-4"
            }`}
            style={{
              boxShadow:
                "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)",
          ...
          <div
            className={`border-[1.47px] w-20 lg:w-20.5 h-22.25 lg:h-22.75 border-[#e4e4e7] dark:border-[#27272A] absolute z-2 bg-[#FFFFFF] dark:bg-[#18181B] rounded-[16px] -bottom-7 -left-4 flex flex-col justify-between items-center p-4.5 lg:border-2 transform ${
              reducedMotion ? "" : "-rotate-8 dark:rotate-0"
            }`}
            style={{
              boxShadow:
                "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)",
          ...
          <div className="w-full flex flex-col gap-4">
            ...
            <div className="flex justify-between items-center gap-3 text-[#52525B] dark:text-[#A1A1AA] font-bold text-xs w-full">
              <a
                href="#"
                className="rounded-[16px] border-[#e4e4e7] dark:border-[#27272A] border-[1.34px] p-4 w-full h-33.5 flex flex-col justify-between lg:border-2"
              >
                <div className="flex justify-between items-center w-full">
                  <div
                    className="bg-[#FFFFFF] dark:bg-[#18181B] w-10 h-10 rounded-[12px] flex justify-center items-center"
                    style={{
                      boxShadow: "0px 4px 20px 0px rgba(139, 92, 246, 0.25)",
                    }}
                  >
                    <Image
                      src={stellar}
            ...
            <div className="flex justify-between items-center gap-3 text-[#52525B] dark:text-[#A1A1AA] font-bold text-xs w-full">
              {escrowCardInfos.map((escrowCardInfo) => (
                <div
                  key={escrowCardInfo.id}
                  className="border-[#e4e4e7] dark:border-[#27272A] border-[1.34px] h-11 w-full flex items-center justify-center rounded-[16px] lg:border-2"
                >
